...
\begin{abstract}
  ...
  The measurement is performed with a dataset of 13 TeV proton-proton collisions recorded by the CMS detector at the CERN Large Hadron Collider, corresponding to an integrated luminosity of 137 \fb.
\end{abstract}
