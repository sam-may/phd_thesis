...
\begin{figure} [htbp!]
    \centering
    \begin{tabular}{c c}
        \includegraphics[width=0.48\linewidth]{figures/tth/ttHHadronic_MVA_ttZ_21Feb2020.pdf}
        \includegraphics[width=0.48\linewidth]{figures/tth/ttHLeptonic_MVA_ttZ_21Feb2020.pdf}
    \end{tabular}
