...
\begin{figure} [h!]
    \centering 
    \begin{tabular}{c c}
        \includegraphics[width=0.6\linewidth]{figures/event_reconstruction_and_selection/figs_recoenergy_Fig-2a.png} &
        \includegraphics[width=0.6\linewidth]{figures/event_reconstruction_and_selection/figs_recoenergy_Fig-2b.png}
    \end{tabular}
