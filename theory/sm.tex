...
Starting with the Dirac Lagrangian (Eqn.~\ref{eqn:dirac_lagrangian}), suppose we impose that its resulting field equations must be invariant under a local phase transformation
...
%Conceptually, this seems like a reasonable request for the 

Initially, the Dirac Lagrangian is not invariant under the local phase transformation (Eqn.~\ref{eqn:local_phase}), as an extra term from the derivative of $\theta$ appears:
